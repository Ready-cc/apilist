...
<body>
    ...
    <p>地址：<input id="url" name="url" style="width:600px" value="http://test.settle.api.mall.autohome.com.cn/account/query" /></p>
    <form id="form1" action="" method="post">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    <input id="user_source_id" name="user_source_id" value="100004" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="partner_id" name="partner_id" value="10000004" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="out_user_id" name="out_user_id" value="62669" />
                </td>
            </tr>           
