...
<body>
    ...
    <p>地址：<input id="url" name="url" style="width:600px" value="http://test.settle.api.mall.autohome.com.cn/account/createaccount" /></p>
        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="col2">
                    <input id="account_type" name="account_type" value="" />
                </td>
            </tr>  
            <tr>
                <td class="col1">
            ...
            <tr>
                ...
                <td class="col2">
                    <input id="acct_identity" name="acct_identity" value="" />
                </td>
            </tr>         
        </table>
    </form>
