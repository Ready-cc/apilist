...
<body>
    ...
    <p>地址：<input id="url" name="url" style="width:600px" value="http://test.settle.api.mall.autohome.com.cn/account/createpersonal" /></p>
    <form id="form1" action="" method="post">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    <input id="uid" name="uid" value="2015051801" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="login_name" name="login_name" value="13311111111" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="member_name"  name="member_name" value="nickname" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="member_source"  name="member_source" value="99999" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="verify_mobile"  name="verify_mobile" value="verify_mobile" />
                </td>
            </tr>
