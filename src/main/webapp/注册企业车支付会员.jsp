...
<body>
    ...
    <p>地址：<input id="url" name="url" style="width:600px" value="http://test.settle.api.mall.autohome.com.cn/account/createenterprise" /></p>
    <form id="form1" action="" method="post">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    <input id="uid" name="uid" value="2016082501" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="login_name" name="login_name" value="chenchunfeng2@autohome1.com.cn" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="enterprise_name"  name="enterprise_name" value="汽车之家电商7" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="member_name"  name="member_name" value="汽车之家电商7" />
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input id="member_source"  name="member_source" value="5" />
                </td>
            </tr>
